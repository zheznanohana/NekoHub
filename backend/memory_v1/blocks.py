...
BLOCKS=[block("text",{"text":S}), block("memory.cards",{"items":array(CARD)}),
        block("memory.network",{"nodes":array(obj({"id":S,"kind":S,"level":{"enum":["raw","day","week","month","entity"]},"label":S,"text":S,"period":S,"evidence_ids":IDS})),
        ...
        block("memory.receipt",{"data":obj({"state":S,"event_id":{"type":["string","null"]},"job_id":S,"id":S,"reason":S,"imported":N,"duplicate":N,"failed":N,"source":S,"day":S,"version":N,"indexed":N,"dropped":N,"pending":N,"embed_state":S,"embed_embedded":N,"embed_pending":N,"history_complete":{"type":"boolean"},"next_since":{"type":["integer","null"]},"next_page":{"type":["integer","null"]}},[])})]
