...
BLOCKS=[block("text",{"text":S}), block("memory.cards",{"items":array(CARD)}),
        ...
        block("memory.receipt",{"data":obj({"state":S,"event_id":{"type":["string","null"]},"job_id":S,"id":S,"reason":S,"imported":N,"history_complete":{"type":"boolean"},"next_since":{"type":["integer","null"]},"next_page":{"type":["integer","null"]}},[])})]
